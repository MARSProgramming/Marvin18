...
/**
 * Command that displays the Algae Wants Piece animation until a piece is detected. Should be ran in
 * a race group.
 */
public class BlingAlgaeWantsPiece extends Command {
  ...
  public void initialize() {
    blingSubsystem.setAnimation(ALGAE_WANTS_PIECE_ANIMATION);
  }
