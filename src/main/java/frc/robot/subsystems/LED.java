...
public class LED extends SubsystemBase {
    ...
    public static enum LEDSegment {
       ...
       // reserve this for different portions of LEDs. Have other students test this.
    ...
    public static class Color {
        ...
        public Color dim(double dimFactor) {
            int newRed = (int) (MoreMath.ensureRange(red * dimFactor, 0, 200));
            int newGreen = (int) (MoreMath.ensureRange(green * dimFactor, 0, 200));
            int newBlue = (int) (MoreMath.ensureRange(blue * dimFactor, 0, 200));
